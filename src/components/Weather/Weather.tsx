...
const Weather = () => {
    ...
    const handleSelectLocation = (location: string): void => {
        ...
        console.log(current[Object.keys(current)[0]]);
        console.log(current[Object.keys(current)[0]].cloud_status);
            ...
            >
                ...
                <Stack alignItems={'center'} direction={'row'} spacing={1}>
                    <ReactAnimatedWeather
                        icon={
                            weatherIconMapping[current[Object.keys(current)[0]].cloud_status] || 'CLOUDY'
                        }
                        color={theme.palette.grey[500]}
                        size={25}
                        animate
