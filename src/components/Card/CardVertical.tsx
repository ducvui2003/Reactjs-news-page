            ...
            <Card sx={{height: "100%"}}>
                <CardActionArea sx={
                    ...
                    <Box sx={{flexBasic: "140", ...cssImage}}>
                        {isLoading ? <Skeleton variant="rectangular" width={210} height={118}/> : <CardMedia
                            component="img"
                            height="100%"
                    ...
                    <CardContent sx={{width: "100%"}}>
                        {isLoading ? <Skeleton width="100%"/>
                            : <ClampedTypography lineClamp={2} gutterBottom variant="h5" component="div">{news.title}
                            </ClampedTypography>}
                        {isLoading ? <Skeleton width="100%"/>
                            : <Typography gutterBottom variant="caption">{timeAgo(news.publishDate)}</Typography>}
                        {isLoading ? <Skeleton width="100%"/>
